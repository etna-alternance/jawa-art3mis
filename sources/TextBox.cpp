...
{
  return _currQuote.index;
}

const std::string & TextBox::getTalker() const
{
  return _currQuote.talker;
}

const std::vector<std::string> & TextBox::getTalkers() const
{
  return _dialogue.getTalkers();
}

const std::vector<std::string> & TextBox::getFirstTalkers() const
{
  return _dialogue.getFirstTalkers();
}
